...
<h2><span style={{ textDecoration: "underline", borderRadius: "50px 50px 5px" }} className='head underline  p-3  '> {name}
</span> </h2>
</div>
...
{array.map((item) => (
  <div key={item._id} id='box' className="container-fluid  py-5 px-3  text-white my-5" >
    <div  className="row d-flex">
      ...
      <div className="col-lg-4 col-sm-12 my-3 "><textarea  style={{ height: "20vh", width: "30vh", border: 0 }} value={item.work} id="text"></textarea></div>
      <div className="col-lg-4 col-sm-12 my-2  ">      <button  className=' btn border-0   px-5 fw-bolder text-white' style={{ borderRadius: "1vh" }} onClick={() => handleDelete(item._id)}>Delete</button></div>
...
<h1 className='fs-1 text-dark mx-5'>Create list</h1>
